...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::description_proposals::create_assisted_description_proposal,
            commands::description_proposals::list_assisted_description_proposals,
            commands::description_proposals::list_description_proposal_log,
            commands::description_proposals::update_assisted_description_proposal_section,
            commands::description_proposals::transition_assisted_description_proposal,
            commands::description_proposals::delete_assisted_description_proposal,
            ...
            commands::external_links::open_notion_oauth_authorization_url,
