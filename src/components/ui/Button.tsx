...
export function Button({
  ...
  return (
    <button
      {...buttonProps}
      className={cn(
        "inline-flex h-8 items-center justify-center gap-1.5 rounded px-3 text-sm font-medium transition-colors disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-45",
